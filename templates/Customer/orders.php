...
<?php else: ?>
    <?php foreach ($orders as $order): ?>
        <div class="order-card" onclick="window.location.href='<?= $this->Url->build('/dashboard/orders/' . (int)$order->id) ?>'">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <?= $this->Html->link(
                                    ...
                                    '/dashboard/buy-again/' . (int)$order->id,
                                    [
                                        'class' => 'dropdown-item',
                                        'escape' => false,
