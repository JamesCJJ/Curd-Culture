<?php
// File: templates/Admin/Orders/index.php
/**
 * Admin Orders Index
 *
...
// Refill date inputs from query to avoid empty values on refresh
$fromQuery = (string)($this->request->getQuery('from') ?? '');
$toQuery   = (string)($this->request->getQuery('to')   ?? '');
?>
<div class="admin-orders">
    ...
    <div class="filters-section">
        ...
        <div class="filters-row">
            ...
            <?php
            // Use HTML5 date inputs to reduce invalid strings (pairs with controller-side validation)
            ?>
